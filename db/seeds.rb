...
recipe_1 = Recipe.create!(name: 'Chicken Parm', api_id: '123456789123456789',
...
user_recipe_1 = user_1.user_recipes.create!(recipe_id: recipe_1.id, num_stars: 4, cook_status: false,
                                            saved_status: true, is_owner: true)
user_recipe_2 = user_1.user_recipes.create!(recipe_id: recipe_2.id, num_stars: 5, cook_status: true,
                                            saved_status: true, is_owner: false)

saved_ingredient_1 = user_1.saved_ingredients.create!(ingredient_name: chicken.name, unit_type: chicken.unit_type,
                                                      units: chicken.units)
saved_ingredient_2 = user_1.saved_ingredients.create!(ingredient_name: cheese.name, unit_type: cheese.unit_type,
                                                      units: cheese.units)
saved_ingredient_3 = user_1.saved_ingredients.create!(ingredient_name: ground_beef.name,
                                                      unit_type: ground_beef.unit_type, units: ground_beef.units)
saved_ingredient_4 = user_1.saved_ingredients.create!(ingredient_name: eggs.name, unit_type: eggs.unit_type,
                                                      units: eggs.units)
