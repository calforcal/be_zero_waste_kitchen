  ...
  describe 'Create One Recipe' do
    describe 'happy paths' do
      it 'can create one merchant' do
        ...
        expect(created_recipe.instructions).to eq(['1. Rinse spinach and lettuce',
                                                   '2. Get out that dressing give it a shake', '3. Add chickpeas and tomatoes and strawberries', '4. Shake it off yeah yeah shake it off'])
