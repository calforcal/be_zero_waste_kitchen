...
describe NutritionService do
  describe 'instance methods' do
    describe '#ingredients weight' do
      it 'can take in a string of ingredients and return nutrition facts' do
        VCR.use_cassette("spec/fixtures/vcr_cassettes/NutritionService/instance_methods/_ingredients_weight/can_take_in_a_string_of_ingredients_and_return_nutrition_facts.yml") do
          query = "2 lbs chicken"
